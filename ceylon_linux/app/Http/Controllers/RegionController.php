...
class RegionController extends Controller
{
    ...
    public function getRegionForTerritory()
    {
        $allRegionAdminTerritory = Region::pluck('region_name', 'region_code');
        return view('admin-territory', compact('allRegionAdminTerritory'));
    }
}
